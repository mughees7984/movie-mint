...
//     subtitle: "Real-time cryptocurrency trading with advanced analytics.",
...
//     subtitle: "Create unique digital artworks using machine learning algorithms.",
...
//     subtitle: "Automated security analysis for blockchain smart contracts.",
...
//                     <button className="w-9 h-9 rounded-full border border-zinc-600 hover:border-lime-400 flex items-center justify-center group/btn transition-all duration-300 hover:bg-lime-400/10">
//                       <svg
//                         className="w-4 h-4 text-zinc-400 group-hover/btn:text-lime-400 transition-colors duration-300"
//                         fill="none"
//                         stroke="currentColor"
//                         viewBox="0 0 24 24"
//                       >
...
//               <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
//                 <div
//                   className="absolute inset-0 rounded-2xl border-2 border-transparent bg-gradient-to-r from-lime-400 via-green-400 to-lime-400 bg-clip-border animate-pulse"
//                   style={{
//                     WebkitMask:
...
//         }}
//         className="pb-10 px-1 sm:px-2 md:px-4 lg:px-6"
//       >
//         {projects.map((project) => (
//           <SwiperSlide key={project.id}>
//             <div className="group relative bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-700 rounded-2xl overflow-hidden shadow-2xl hover:shadow-lime-400/20 transition-all duration-500 border border-zinc-700 hover:border-lime-400/30">
//               {/* Glow effect */}
//               <div className="absolute inset-0 bg-gradient-to-br from-lime-400/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
...
//               <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
//                 <div className="absolute inset-0 rounded-2xl border-2 border-transparent bg-gradient-to-r from-lime-400 via-green-400 to-lime-400 bg-clip-border animate-pulse"
